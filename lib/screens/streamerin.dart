...
void main() {
  runApp(const ImportYardApp());
}

class ImportYardApp extends StatelessWidget {
  const ImportYardApp({super.key});
  ...
  Future<void> _fetchContainerData() async {
    ...
    try {
      ...
      final response = await http.get(Uri.parse(
          'https://fusiontecsoftware.com/sancowebapi/sancoapi/GetGateINDetails?dates=$formattedStart~$formattedEnd'));
